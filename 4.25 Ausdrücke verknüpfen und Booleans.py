...
country = "us"
age = 20
if (country == "us" and age >= 20) or (country != "us" and age >= 18):
    print("Diese Person darf Alkohol trinken")
# In dieser Abfrage werden Country und Alter in Kombination verglichen. Wenn jemand aus den USA ist, darf er erst Alkohol trinken,
# wenn er über 20 ist. Wenn er nicht aus den USA ist, darf er Alkohol trinken,wenn er über 18 ist
